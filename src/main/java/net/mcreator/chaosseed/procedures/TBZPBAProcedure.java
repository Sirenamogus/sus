...
public class TBZPBAProcedure extends ChaosSeedModElements.ModElement {
	public TBZPBAProcedure(ChaosSeedModElements instance) {
		super(instance, 14);
	}
	...
	public static void executeProcedure(Map<String, Object> dependencies) {
		if (dependencies.get("x") == null) {
			if (!dependencies.containsKey("x"))
				ChaosSeedMod.LOGGER.warn("Failed to load dependency x for procedure TBZPBA!");
			return;
		}
		if (dependencies.get("y") == null) {
			if (!dependencies.containsKey("y"))
				ChaosSeedMod.LOGGER.warn("Failed to load dependency y for procedure TBZPBA!");
			return;
		}
		if (dependencies.get("z") == null) {
			if (!dependencies.containsKey("z"))
				ChaosSeedMod.LOGGER.warn("Failed to load dependency z for procedure TBZPBA!");
			return;
		}
		if (dependencies.get("world") == null) {
			if (!dependencies.containsKey("world"))
				ChaosSeedMod.LOGGER.warn("Failed to load dependency world for procedure TBZPBA!");
			return;
		}
		...
		if ((Math.random() < 0.95)) {
			world.setBlockState(new BlockPos((int) x, (int) (((y - Math.random()) + Math.random()) + Math.random()), (int) (z + 1)),
					TBZPBlock.block.getDefaultState(), 3);
		} else {
			if ((Math.random() < 0.3)) {
